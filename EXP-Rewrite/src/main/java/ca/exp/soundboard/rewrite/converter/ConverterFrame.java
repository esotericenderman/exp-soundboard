                ...
                if ((ConverterFrame.this.inputfiles != null) && (ConverterFrame.this.outputfile != null)) {
                    ...
                    if (session == 0) {
                        ...
                        if (ConverterFrame.this.inputfiles.length < 2) {
                            ...
                            ConverterFrame.this.outputFileLabel
                                    .setText(ConverterFrame.this.outputfile.getAbsolutePath());
                        }
                    }
    ...
    private class ConvertProgressListener implements EncoderProgressListener {
        ...
        public void message(String m) {
            if ((ConverterFrame.this.inputfiles.length > 1) && (this.current < ConverterFrame.this.inputfiles.length)) {
                ConverterFrame.this.encodingMessageLabel
                        .setText(this.current + "/" + ConverterFrame.this.inputfiles.length);
            }
        }
