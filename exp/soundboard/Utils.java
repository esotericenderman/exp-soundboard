 ...
 public class Utils
 {
   ...
   public static String[] getMixerNames(DataLine.Info lineInfo)
   {
     ...
     Mixer.Info[] arrayOfInfo1; int j = (arrayOfInfo1 = info).length; for (int i = 0; i < j; i++) { Mixer.Info elem = arrayOfInfo1[i];
   ...
   public static void startMicInjector(String inputMixerName, String outputMixerName)
   {
     ...
     int j = (arrayOfString = MicInjector.getMixerNames(MicInjector.targetDataLineInfo)).length; for (int i = 0; i < j; i++) { String mixer = arrayOfString[i];
       if (mixer.equals(inputMixerName)) {
         inputexists = true;
       }
     }
     j = (arrayOfString = MicInjector.getMixerNames(MicInjector.sourceDataLineInfo)).length; for (i = 0; i < j; i++) { String mixer = arrayOfString[i];
   ...
   public static boolean initGlobalKeyLibrary()
   {
     ...
     catch (NativeHookException ex)
     {
       ...
       JOptionPane.showMessageDialog(null, "Error: " + ex.getMessage(), "Error occured whilst initiating global hotkeys", 
         0);
     }
     return true;
   }
   ...
   public static ArrayList<Integer> stringToIntArrayList(String string)
   {
     ...
     String[] arrayOfString1; int j = (arrayOfString1 = numberstring).length; for (int i = 0; i < j; i++) { String s = arrayOfString1[i];
       if (!s.equals("")) {
   ...
   public static boolean stopFilePlaying(File file)
   {
     ...
     int j = (arrayOfThread1 = threads).length; for (int i = 0; i < j; i++) { Thread thread = arrayOfThread1[i];
